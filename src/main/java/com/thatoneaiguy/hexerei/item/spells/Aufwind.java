...
public class Aufwind extends Item {
	public Aufwind(Settings settings) {
		super(settings);
	}
	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
		...
		if (!world.isClient) {
			AufwindEntity aufwindEntity = new AufwindEntity(world, user, x - user.getX(), y - user.getEyeY(), z - user.getZ());
			aufwindEntity.setPosition(x, y, z);
			world.spawnEntity(aufwindEntity);
		}
